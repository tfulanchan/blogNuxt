...
<template>
  <div>
    <div v-for="post in data" :key="post._id" class="max-w-md mx-auto bg-white hover:border hover:border-green-500 rounded-xl shadow-lg overflow-hidden md:max-w-2xl mb-5">
      <div  class="px-6 py-4">
